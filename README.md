...
## C++ FCF::Union Bidirectional Conversion Union Type Framework (With JSON Support)
...
- `bool,`
- `std::string,`
- `fcf::UnionVector /*std::vector<fcf::Union>*/,`
- `fcf::UnionMap /*std::map<fcf::Union, fcf::Union, fcf::MapLess>*/,`
